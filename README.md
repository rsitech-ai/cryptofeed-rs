...
Adapter coverage and operational gaps are recorded in
[`docs/plan/maturity_matrix.md`](docs/plan/maturity_matrix.md) and
[`docs/plan/venue_channel_audit.md`](docs/plan/venue_channel_audit.md).
