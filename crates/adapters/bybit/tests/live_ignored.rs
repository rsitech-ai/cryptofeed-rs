...
use marketfeed_adapter_bybit::{BybitCategory, BybitFactory};
...
#[tokio::test]
#[ignore = "live network: cargo test -p marketfeed-adapter-bybit -- --ignored --nocapture"]
async fn live_bybit_linear_trade_or_quote() {
    let factory = BybitFactory {
