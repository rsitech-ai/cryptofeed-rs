//! Shared JSON deserialize helpers for Binance Spot / USD-M / Coin-M hot-path decode.
//!
//! # ponytail
...
//! Upgrade = evidence-backed enable criteria + automatic connection→core map.
...
mod tests {
    ...
    fn serde_simd_value_and_typed_parity() {
        let raw = br#"{"e":"trade","t":42,"nested":{"x":1}}"#;
